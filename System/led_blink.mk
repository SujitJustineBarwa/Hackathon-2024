...
MATLAB_ROOT          = "E:/MATLAB_2019"
ALT_MATLAB_ROOT      = "E:/MATLAB_2019"
MATLAB_BIN           = "E:/MATLAB_2019/bin"
ALT_MATLAB_BIN       = "E:/MATLAB_2019/bin"
S_FUNCTIONS_LIB      = 
NUMST                = 1
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
# Additional includes
ADD_INCLUDES = \
 -IC:/Windows/System32  -IC:/Windows/System32/led_blink_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IE:/MATLAB_Add_On/STM32-MAT/STM32/addSrc/inc 
...
%.o: $(subst ",,E:/MATLAB_Add_On/STM32-MAT/STM32/addSrc/src)/%.cpp
	@echo ### Source $< done

%.o: $(subst ",,C:/Windows/System32/led_blink_stm32)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,E:/MATLAB_Add_On/STM32-MAT/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Source $< done

%.o: $(subst ",,C:/Windows/System32/led_blink_stm32)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
